...
public class MainActivity extends Activity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //when we click nothing happens, we need an event listener
        l.setOnItemClickListener(this);
    }

    @Override
    //param1 the main list view that was clicked, 2 is the row which was clicked, each row is a text view, 3 int i which is just position, 4 long is the id that was generated by your computer
